...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <aside className={`fixed top-0 left-0 h-full w-64 z-30 bg-white/80 shadow-2xl backdrop-blur-2xl border-r border-slate-100 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 flex flex-col`}>  
